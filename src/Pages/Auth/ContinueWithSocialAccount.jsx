    ...
    <div className="mt-4">
      ...
      <div className="flex items-center justify-between mt-6">
        <button
          ...
          className="flex items-center justify-center btn btn-neutral dark:text-white w-[50%] md:w-[82%] "
        >
          <svg
        ...
        <button
          ...
          className="flex items-center justify-center btn w-[48%] md:w-[15%] btn-neutral dark:text-white"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
